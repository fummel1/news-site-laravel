...
class ArticlesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('main_image')) {
            ...
            $image_name_withount_ext = pathinfo($file, PATHINFO_FILENAME);

            $ext = $request->file('main_image')->getClientOriginalExtension();

            $image_name = $image_name_withount_ext."_".time().".".$ext;
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/')->with('success', 'Статья обновлена');
    }
    ...
    public function destroy($id)
    {
        ...
        $article->delete();
        return redirect('/')->with('success', 'Статья удалена');
    }
}
